...
func (nr NewsRepo) CategoryByID(ctx context.Context, id int64, ops ...OpFunc) (*Category, error) {
...
func (nr NewsRepo) DeleteCategory(ctx context.Context, id int64) (deleted bool, err error) {
...
func (nr NewsRepo) NewsByID(ctx context.Context, id int64, ops ...OpFunc) (*News, error) {
...
func (nr NewsRepo) DeleteNews(ctx context.Context, id int64) (deleted bool, err error) {
...
func (nr NewsRepo) TagByID(ctx context.Context, id int64, ops ...OpFunc) (*Tag, error) {
...
func (nr NewsRepo) DeleteTag(ctx context.Context, id int64) (deleted bool, err error) {
